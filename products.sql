...
SELECT "orders"."id", "orders"."order_date", "products"."description", "line_items"."quantity", "products"."unit_price", "line_items"."unit_price", "orders"."total"
FROM "line_items"
...
WHERE "products"."id" = 5
GROUP BY "warehouse"."warehouse";

-- 4.	Which warehouses have diet pepsi?

SELECT "warehouse_product"."product_id" = 6 AS "truth", "warehouse_product"."warehouse_id"
FROM "warehouse_product";
